...
class HeadHunterAPI:
    ...
    def get_parsing(self, json_list):
        vacancy_list = []
        for item in json_list:
            company_id = item["employer"]["id"]
            name_company = item["employer"]["name"]
            ...
            vacancy = [company_id, name_company, name_vacancy, url_vacancy, salary_vacancy, info_vacancy]
    ...
    def add_employer(self, company_id):
        self.param['employer_id'] = company_id
